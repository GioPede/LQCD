...
// multiplication
inline void operator*=(SU3& first, SU3& other) noexcept{
    SU3 result;
    /*
    //REAL
...
*/
    for(int i = 0; i < 3; i++){
        for(int j = 0; j < 3; j++){
            ...
            for(int k = 0; k < 3; k++){
                result.mat[2 * (3*i + j)] += first.mat[2 * (3*i + k)] * other.mat[2 * (3*k + j)]
                                       -first.mat[2 * (3*i + k) + 1] * other.mat[2 * (3*k + j) + 1];
                result.mat[2 * (3*i + j) + 1] += first.mat[2 * (3*i + k)] * other.mat[2 * (3*k + j) + 1]
                                           +first.mat[2 * (3*i + k) + 1] * other.mat[2 * (3*k + j)];
...
inline SU3 operator * (SU3& first, SU3& other) noexcept{
    SU3 result;
    /*
    //REAL
    result.mat[0] =  mat[0] * other.mat[0] - mat[1]*other.mat[1] + mat[2] * other.mat[6] - mat[3]*other.mat[7] + mat[4] * other.mat[12] - mat[5]*other.mat[13];
